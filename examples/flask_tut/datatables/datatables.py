...
class DataTables:
    ...
    def __init__(self, request, query, columns, allow_regex_searches=False):
        ...
        #print(list(map(lambda x: x.column_name,columns)))
        self.results = None
    ...
    def _set_yadcf_data(self, query):
        ...
        #print(column_params_map)
        #for i, col in enumerate(self.columns):
        for i, col in column_params_map:
            #print(col.yadcf_data)
            if col.yadcf_data:
                ...
                if col.search_method in [
                    ...
                    #Added the below if statement so only that data with only 
                    #null values is not returned.
